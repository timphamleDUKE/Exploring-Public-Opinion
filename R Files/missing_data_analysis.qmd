...
ggplot(top_10_missing_count, aes(x = neg_count, y = variable)) +
  geom_bar(stat = "identity", fill = "#b4b5b9", color = "#b4b5b9") +
  geom_bar(data = top_10_missing_count[1, ], stat = "identity", fill = "#7b3ad4", color = "#7b3ad4") +
  labs(
...
ggplot(least_10_missing_count, aes(x = neg_count, y = variable)) +
  geom_bar(stat = "identity", fill = "#b4b5b9", color = "#b4b5b9") +
  geom_bar(data = least_10_missing_count[1, ], stat = "identity", fill = "#7b3ad4", color = "#7b3ad4") +
  labs(
...
ggplot(least_10_demographic_count, aes(x = neg_count, y = variable)) +
  geom_bar(stat = "identity", fill = "#b4b5b9", color = "#b4b5b9") +
  geom_bar(data = least_10_demographic_count[1, ], stat = "identity", fill = "#7b3ad4", color = "#7b3ad4") +
  labs(
