...
anes_2024 |>
  select(lib_con_7pt, sexual_harassment, budget_healthcare, gun_ban_assault_rifles, gun_difficulty, blm_thermometer) |>
  gg_miss_fct(fct = lib_con_7pt) +
  scale_fill_gradient(low = "white", high = "#7b3ad4") +
  theme_minimal() +
...
anes_2024 |>
  select(lib_con_7pt, import_limits, free_trade, illegal_immigrant_thermometer, mexico_threat, immigration_crime) |>
  gg_miss_fct(fct = lib_con_7pt) +
  scale_fill_gradient(low = "white", high = "#7b3ad4") +
  theme_minimal() +
