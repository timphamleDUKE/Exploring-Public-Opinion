...
anes_2024 <- anes_2024 |>
  ...
  select(-'...1', -pre_full, -post_full, -full_var_psu, -full_var_stratum)
```
...
ggplot(least_10_missing_count, aes(x = neg_count, y = variable)) +
  ...
  geom_bar(data = least_10_missing_count[2, ], stat = "identity", fill = "#7b3ad4") +
  geom_text(aes(label = neg_count, hjust = 1.15), color = "white", family = "Source Sans 3") +
...
anes_2024 |>
  select(
    ...
    birthright_citizenship, lgbt_discrimination, lgbt_adoption, gay_marriage_view, gay_marriage,
...
anes_2024 |>
  select(
    ...
    lgbt_adoption, gay_marriage_view, gay_marriage, diversity, sexual_harassment, 
