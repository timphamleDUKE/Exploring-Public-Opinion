...
ggplot(top_10_missing_count, aes(x = neg_count, y = variable)) +
  ...
  geom_text(aes(label = neg_count, hjust = 1.15), color = "white") +
  theme_minimal() +
  theme(
    text = element_text(family = "sans"),
    axis.title.x = element_text(color = "black"),      # x-axis title color
    axis.title.y = element_text(color = "black"),       # y-axis title color
...
# race_christian_missing <- compute_missing_by(
#  design      = anes_design,
#  group_var   = "race_label",
#  question_var= "christian_thermometer"
#)
